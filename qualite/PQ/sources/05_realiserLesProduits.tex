...
Le principe du développement de produit du PIC \nomPIC{} se base sur une méthode en spirale. La réalisation des produits demandés par le client est donc décomposée en sprints de durée prédéfinie (cf Partie 4.1.4 : Planning de principe).
