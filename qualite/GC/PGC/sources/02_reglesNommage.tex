...
\begin{longtable}{|p{12cm}|c|c|}
 ...
 \multicolumn{3}{|c|}{\textbf{\bsc{Référentiel Développement}}}\\
    ...
    LotX & lotX & -\\
    \hline
    \hspace{1cm} Cahier De Recettes & CDR & l\\
    \hline
...
Dans le cas des documents n'ayant pas besoin d'être approuvé (par exemple DSI), X est le numéro de version classique et commence à 1, YY n'est pas utilisé.
