...
Le type Activite est une énumération qui définit les différentes activités dont un bénévole peut être responsable, mais également si un bénébole est un administrateur d'un comité et/ou d'une région.
