...
\centering
	...
	\hline
	 \Michel & Suivre les Risques et Opportunités & 1.2.3.2 & À partir du début de la deuxième période. \\
	\hline
	\end{tabularx}
\end{table}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{images/AnalyseRisque_nPourquoi_FDR006}
\end{figure}
\end{landscape}