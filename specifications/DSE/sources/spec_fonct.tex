...
Il pourra exister plusieurs administrateurs globaux, plusieurs administrateurs locaux et plusieurs bénévoles. 
...
Concernant le niveau de la classe, nous reprendrons ceux proposés dans le formulaire actuelle. Si la classe regroupe le niveau Grande Section et CP, l'information doit être précisée en remarque.
