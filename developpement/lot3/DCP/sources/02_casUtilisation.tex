...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{casDUtilisation/images/fonctionnalite9Attribution.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.40]{casDUtilisation/images/fonctionnalite10Attribution.png}
	\caption{Cas d'utilisation~: Attribution de frimousse }
	\label{diagrammeCasUtilisation9}
\end{figure}
