...
\destinataires{}%\nomApprobateur{}, \nomTuteurQualite, \nomEquipe, \nomPIC{}}
\resume{Le présent document contient la présentation du \DSI{} \nomEquipe.}
\motsCles{\DSICourt{}}
...
\label{architecture}
\input{sources/02_architecture.tex}

\chapter{Présentation de la solution}
\label{presentation}
\input{sources/03_presentationSolution.tex}

\chapter{Description détaillée des lots}
\label{description}
\input{sources/04_descriptionDetailleeLots.tex}
