...
GanttProject est un logiciel open-source utilisé pour l'avancement de projet. Le \CP{} l'utilisera pour agencer les tâches en visualisant un diagramme de GANTT.

\subsubsection*{Redmine}

Redmine est un logiciel open-source utilisé pour l'avancement de projet et comme gestionnaire de problèmes.\\
Nous l'utiliserons pour la gestion des faits techniques en tant que complément à PGPIC. Son utilisation sera explicitée dans la partie \ref{Suivi de la qualite} (Suivi de la Qualité).
