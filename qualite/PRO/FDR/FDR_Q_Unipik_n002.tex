...
\begin{enumerate}
	...
	\item Le cehf de projet prend le rôle de médiateur et convoque les membres concernés à une réunion de négociation puis leur demande de mettre en oeuvre la méthode DESC.
\end{enumerate}
...
\begin{figure}
	\centering
	\includegraphics[scale=1]{images/AnalyseRisque_nPourquoi_FDR002.png}
\end{figure}
\end{landscape}