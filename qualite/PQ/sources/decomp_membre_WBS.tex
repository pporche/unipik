...
\begin{longtable}{|p{3.0cm}|p{14.5cm}|p{5cm}|}
	...
	% Corps du tableau
        ...
        \ligneMaj{1}{Réaliser les produits}{\DGQDEUXCourt{} - Chapitre 6}
        \ligneSup{1.1}{Mener la phase de spécification}{\DGQDEUXCourt{} - Partie 6.2} 
        \ligneMed{1.1.1}{Imaginer une solution}{\DGQDEUXCourt{} - Partie 6.2}
        \ligneSub{1.1.1.1}{Exécuter une revue formelle de fin de phase}{\DGQDEUXCourt{} - Partie 6.2.4}
        \ligneMed{1.1.2}{Rédiger des fiches de faits techniques}{\DGQDEUXCourt{} - Partie 6.2.3}
        \ligneSup{1.2}{Mener la phase de conception préliminaire}{\DGQDEUXCourt{} - Partie 6.3}
        \ligneMed{1.2.1}{Concevoir l'architecture du lot}{\DGQDEUXCourt{} - Partie 6.3.1} 
        \ligneSub{1.2.1.1}{Définir les artefacts de conception}{\DGQDEUXCourt{} - Partie 6.3.1}
        \ligneSub{1.2.1.2}{Définir l'architecture des packages}{\DGQDEUXCourt{} - Partie 6.3.3}
        \ligneMed{1.2.2}{Rédiger le plan de test d'intégration(PTI)}{\DGQDEUXCourt{} - Partie 6.3.5}
        \ligneMed{1.2.3}{Etablir le dossier de conception préliminaire (DCP)}{\DGQDEUXCourt{} -  Partie 6.3.2}
        \ligneSup{1.3}{Réalisation d'un Package}{\DGQDEUXCourt{} - Partie 6.4}
        \ligneMed{1.3.1}{Mener la phase de conception détaillée}{\DGQDEUXCourt{} - Partie 6.4.1}
        \ligneSub{1.3.1.1}{Définir les classes et attributs}{\DGQDEUXCourt{} - Partie 6.4.1.1}
        \ligneSub{1.3.1.2}{Elaborer le pseudo-code et les commentaires des méthodes}{\DGQDEUXCourt{} - Partie 6.4.1.1}
        \ligneSub{1.3.1.3}{Préparer les Tests Unitaires}{\DGQDEUXCourt{} - Partie 6.4.1.1}
        \ligneMed{1.3.2}{Phase de dévellopement}{\DGQDEUXCourt{} - Partie 6.4.2}
        \ligneSub{1.3.2.1}{Déterminer le code source}{\DGQDEUXCourt{}- Partie 6.4.2}
        \ligneSub{1.3.2.2}{Ecrire le code source}{\DGQDEUXCourt{} - Partie 6.4.2}
        \ligneSub{1.3.2.3}{Dévelloper un package}{\DGQDEUXCourt{} - Partie 6.4.2}
        \ligneMed{1.3.3}{Mener la phase de développement unitaire}{\DGQDEUXCourt{} - Partie 6.4.3}
        \ligneSub{1.3.3.1}{Exécuter les tests "boites blanches"}{\DGQDEUXCourt{} - Partie 6.4.3.1}
        \ligneSub{1.3.3.2}{Exécuter les tests "boites noires"}{\DGQDEUXCourt{} - Partie 6.4.3.1}
        \ligneSub{1.3.3.3}{Compléter le journal de test}{\DGQDEUXCourt{} - Partie 6.4.3.1}
        \ligneSup{1.4}{Mener la phase de validation}{\DGQDEUXCourt{} - Partie 6.6}
        \ligneMed{1.4.1}{Effectuer la séance de recette provisoire}{\DGQDEUXCourt{} - Partie 6.6.1}
        \ligneSub{1.4.1.1}{Exécution de la totalité des essais prévus dans le cahier de charges}{\DGQDEUXCourt{} - Partie 6.6.1}
        \ligneSub{1.4.1.2}{Etablir la liste exhaustive des écarts}{\DGQDEUXCourt{} - Partie 6.6.1}
        \ligneMed{1.4.2}{Réaliser la période probatoire}{\DGQDEUXCourt{} - Partie 6.6.1}
        \ligneMed{1.4.3}{Effectuer la séance de recette définitive}{\DGQDEUXCourt{} - Partie 6.6.1}
         \ligneSup{1.5}{Mener la phase d'intégration}{\DGQDEUXCourt{} - Partie 6.5}
		 \ligneSup{1.6}{Mener le plan de garantie}{\DGQDEUXCourt{} - Partie 6.7}
