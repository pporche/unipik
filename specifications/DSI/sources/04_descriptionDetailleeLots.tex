...
La première fonctionnalité du système devra permettre les opérations conventionnelles de gestion individuelle comme la création d'un bénévole (voir figure \ref{creationDUnUtilisateurs}) dans le système, la modification des caractéristiques le concernant (voir figure \ref{modificationDUnProfil}) et la suppression d'un bénévole. La suppression d'un bénévole devra être logique et non physique de façon à ne pas effacer l'historique des actions effectuées par ce bénévole. \\
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f1UtilisateurNonConnecte.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f1UtilisateurConnecte.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f2Etablissement.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f3Mailing.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f4ReceptionIntervention.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f5Attribution.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f6MiseAJourIntervention.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4]{images/casDUtilisation/f7Rappels.png}
	 \caption{Cas d'utilisation~: Envoyer des rappels}
	 \label{envoiRappel}
\end{figure}

\input{sources/descriptionDetailleeLots/01_contraintesProduits.tex}
 
\input{sources/descriptionDetailleeLots/02_contraintesRealisation.tex}
