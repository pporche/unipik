...
Les figures \ref{utilisateurNonConnecte} et \ref{utilisateurConnecte} présentent les cas d'utilisation propres aux actions possibles pour un utilisateur connecté et un utilisateur non connecté.
\begin{figure}[H]
	\centering
