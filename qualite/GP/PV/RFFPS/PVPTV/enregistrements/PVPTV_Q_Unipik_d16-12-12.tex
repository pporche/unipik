...
\referenceVersion{PVPTV\_Q\_Unipik\_d16-12-12}
...
L'équipe \nomEquipe{} atteste en ce jour, le 12/12/2016, avoir terminé la rédaction du Plan de Test de Validation le 09/12/2016.
...
\begin{description}
  ...
  \item[Date d'approbation]09/12/2016
  \item[Approbateur]\nomClient
  \item[Date de diffusion]09/12/2016
  \item[Destinataires]\nomEquipe
\end{description}
