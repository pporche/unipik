...
namespace Test\Unipik\Integ\ArchitectureBundle\Controller;
...
class ArchitectureControllerTest extends ControllerTestCase
{
    ...
    {
        self::bootKernel();
        $controllerRes = new ControllerResolver();
        $controller = $controllerRes->getController('Unipik\ArchitectureBundle\Controller');
