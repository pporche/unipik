\begin{pagesService}
	\begin{historique}
		...
		\unHistorique{1.00}{20/01/2016}{\Sergi \newline \Pierre \newline \Michel \newline \Kafui \newline \Matthieu \newline \Mathieu \newline \Julie \newline \Melissa \newline \Florian }{Création}{Toutes}
...
%%Signataires
        \begin{signatures}
	   \uneSignature{Vérificateur}{\RQ{},\newline \CPA}{\Pierre{}}{20/01/2016}{courriel}
       \uneSignature{Validateur}{\CP{}}{\Sergi}{20/01/2016}{courriel}
	   \uneSignature{Approbateur}{Direction Qualité Unité P3}{\nomApprobateur}{20/01/2016}{courriel}
        \end{signatures}
	
	
	\begin{documentsReference}
		\begin{listeDeReferences}
			\uneReference{NF EN ISO 9001}{Septembre 2015}
			\uneReference{\MQ{} de l'Unité P3}{ASI-MQ-MQASI}
	...
	\begin{listeDeDefinitions} 
		...
		\uneTerminologie{Incrément}{Logiciel fonctionnel produit d'un sprint et implémentant une partie du carnet de produit.}
