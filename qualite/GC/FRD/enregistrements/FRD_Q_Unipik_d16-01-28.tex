% Version 1.00, date 28/01/16, auteur Sergi COLOMIES
\documentclass[asi, sansVersion]{picInsa}

\usepackage{vocabulaireUnipik}

\referenceVersion{\FRDCourt\_Q\_Unipik\_d16-01-28}
...
\begin{figure}[H]
		...
		\hline
		Charte Graphique : indique les contraintes à respecter vis-à-vis de l'aspect graphique des documents relatifs au \Client{} & charteGraphiqueUnicef.pdf & pic\_unicef/ressources/Client \\
		\hline
