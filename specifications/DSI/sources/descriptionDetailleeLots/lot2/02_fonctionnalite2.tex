...
caractéristiques le concernant, la suppression d'un établissement.La figure \ref{creationDunEtablissement} présentera le cas d'utilisation concernant la création d'un établissement.\\
