...
\titreGeneral{\JTU}
\sousTitreGeneral{\nomEquipe}
\titreAcronyme{\JTUCourt}
\version{V1.00}
\titreDetaille{\JTUCourt\_D\_\nomEquipe\_\versionPrive}
\referenceVersion{\JTUCourt\_D\_\nomEquipe\_\versionPrive}
\auteurs{\Michel{} }
\destinataires{\nomEquipe}%\nomApprobateur{}, \nomTuteurQualite, \nomEquipe, \nomPIC{}}
\resume{Le présent document contient la présentation du \JTU{} du Lot 1 de \nomEquipe.}
\motsCles{\JTUCourt{}}
...
\input{sources/02_historiqueDesTestsUnitaires.tex}
